...
make migrate DATABASE_URL=postgres://postgres@127.0.0.1:5432/blueeconomy_maritime_intelligence

# seed (idempotent: INSERT ... ON CONFLICT DO NOTHING, deterministic IDs)
SEED_DEMO=true make seed DATABASE_URL=postgres://postgres@127.0.0.1:5432/blueeconomy_maritime_intelligence
```
